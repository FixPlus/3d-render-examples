...
namespace APITest{
    ...
    public:
        explicit VulkanRenderImpl(WindowRef const& window = nullptr, bool enableValidation = true);
        ...
        VertexBufferRef createVertexBuffer(void* initialData, size_t initialSize,
                                           MemoryType = MemoryType::HOST_VISIBLE) override;

        IndexBufferRef createIndexBuffer(void* initialData, size_t initialSize, IndexBuffer::Type indexType = IndexBuffer::Type::INDEX_TYPE_UINT_32,
                                           MemoryType = MemoryType::HOST_VISIBLE) override;
