...
namespace APITest{
    ...
    protected:
        ...
        size_t size_ = 0;
    public:
        explicit Allocatable(VulkanMemoryManager const* alloc): memoryManager(alloc){}
    ...
    public:
        VulkanBuffer(VulkanMemoryManager const* alloc, MemoryType type, VkBufferUsageFlagBits usage, size_t size);
    ...
    struct VulkanVertexBuffer: public VertexBuffer, public VulkanBuffer{
        VulkanVertexBuffer(VulkanMemoryManager const* alloc, MemoryType type, size_t size):
    ...
    struct VulkanIndexBuffer: public IndexBuffer, public VulkanBuffer{
        ...
        VulkanIndexBuffer(VulkanMemoryManager const* alloc, MemoryType type, size_t size, IndexBuffer::Type indType):
                VulkanBuffer(alloc, type, VK_BUFFER_USAGE_INDEX_BUFFER_BIT, size), type(indType){}
    };
    ...
    struct VulkanUniformBuffer: public UniformBuffer, public VulkanBuffer{
        VulkanUniformBuffer(VulkanMemoryManager const* alloc, MemoryType type, size_t size):
    ...
    public:
        VulkanImage(VulkanMemoryManager const* alloc, MemoryType type, VkBufferUsageFlagBits usage, VkImageCreateInfo CI);
    ...
    public:
        VulkanImageInterface(): VulkanImage(nullptr, MemoryType::GPU_PRIVATE,
                                            static_cast<VkBufferUsageFlagBits>(VK_IMAGE_USAGE_FLAG_BITS_MAX_ENUM), VkImageCreateInfo{}){ createDefaultImageView();}
    ...
    class VulkanGeneralImage: public VulkanImageInterface, virtual public VulkanImage{
    public:
    ...
    class VulkanDepthBuffer final: public VulkanImageInterface, virtual public VulkanImage{
        VkImageView depthView_ = VK_NULL_HANDLE;
    public:
        VulkanDepthBuffer(VulkanMemoryManager const* alloc, VulkanDepthBufferCI createInfo);
