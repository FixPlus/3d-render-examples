...
namespace APITest{
    ...
    struct ShaderModule{
        ...
        ShaderModule(VkShaderModule pT, const std::string basicString, VkShaderStageFlagBits bits):
    ...
    public:
        ...
        uint32_t loadShader(std::string const& filename, VkShaderStageFlagBits stage, std::string const& name = "unnamed");
