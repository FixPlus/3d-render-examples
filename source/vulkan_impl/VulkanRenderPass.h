...
namespace APITest{
    ...
    class VulkanColorPass: virtual public VulkanRenderPass, virtual public ColorPass{
    protected:
    ...
    class VulkanOnscreenRenderPass final: public VulkanColorPass, public OnscreenRenderPass{
