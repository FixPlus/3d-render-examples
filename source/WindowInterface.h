...
namespace APITest{
    ...
    /**
     *
     * This struct is for internal use only. This header is NOT a part of Render interface.
     *
     * */
    ...
    public:
        ...
        explicit WindowInterface(uint32_t width = 800, uint32_t height = 600, std::string title = "APITest"):
        ...
        struct {
            std::function<void(uint32_t, uint32_t)> sizeChanged = [](uint32_t, uint32_t){};
