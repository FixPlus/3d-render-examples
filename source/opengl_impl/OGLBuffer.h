...
namespace APITest{
    ...
    public:
        ...
        OGLVertexBuffer(MemoryType memType, size_t size) : OGLBuffer(GL_ARRAY_BUFFER, size, memType){};
    ...
    public:
        GLenum indexType() const{
            switch (indType_) {
                case Type::INDEX_TYPE_UINT_32: return GL_UNSIGNED_INT;
                case Type::INDEX_TYPE_UINT_16: return GL_UNSIGNED_SHORT;
                case Type::INDEX_TYPE_UINT_8: return GL_UNSIGNED_BYTE;
                default: return 0;
            }
        }
    ...
    struct OGLUniformBuffer: public UniformBuffer, public OGLBuffer{
        ...
        OGLUniformBuffer(MemoryType memType, size_t size) : OGLBuffer(GL_UNIFORM_BUFFER, size, memType) {};
