 ...
 * ----------------------------------------- basic/main.cpp ---------------------------------------------------------
 *
 * This example demonstrates the basics of usage this wrapper library and APIs themself.
 *
 * */
...
EXAMPLE_MAIN_HEADER(Basic)
    ...
    // createOnscreenColorPass() - retrieves handle for a RenderPass object - a description of draw commands and
    // target image we are drawing into. This particular function gives RenderPass that describes window surface
    // rendering.
